...
<body>
   <?php get_header(); ?>
   <div class="container">
      <!-- h-100 ver si sacamos este container !-->
      <div class="row" > <!--h-100!-->
        
         <div class="col-md-8 offset-md-2 mt-5 text-center" style="padding-right:0px;padding-left:0px">
          <img src="<?php echo THEME_URL ?>/img/img-bio-laura-alonso.jpg" class="w-100">
          <h1 class="mt-5 titulo color-primary">Laura Alonso</h1>
           <p class="sub-text text-center p-mobile mt-4" style="width:75%">Consultora especializada en políticas de buen gobierno y transformaciones institucionales. Acompaño líderes, gobiernos y empresas. Analista política. Docente y tallerista.</span> 
                  <hr class="mb-5 mt-5" style="width:20%">
         </div>
...
<div class="container">
  <div class="row align-items-end">
    <div class="col-lg-3">
      <p class="destacado" >"xxx"</p>
    </div>
     <div class="col-lg-6">
      <p class="text-body mb-4">Soy argentina, nací en la Ciudad Autónoma de Buenos Aires. Siempre me interesaron los asuntos públicos, por eso estudié Ciencia Política en la Universidad de Buenos Aires y obtuve una maestría en políticas públicas en la London School of Economics. <strong>Me encanta transformar, inspirar y acompañar cambios en organizaciones y personas.</strong></p>
    </div>
      <div class="col-lg-3">
      <span></span>
      </div>
      ...
      <div class="col-lg-6">
      <p class="text-body mb-4">A lo largo de mi carrera, asesoré ONG, proyecté leyes innovadoras, diseñé e implementé políticas públicas, armé equipos y desarrollé planes estratégicos. Con vocación y pasión trabajo por la promoción del buen gobierno, la incorporación de la tecnología y la transparencia.</p>

      <p class="text-body mb-4">Fui miembro del Congreso Nacional de mi país y directora de Poder Ciudadano, capítulo argentino de Transparencia Internacional. También fui profesora de la Universidad de Buenos Aires muchos años.</p>

    </div>

    <div class="col-lg-3 align-items-end">
     <p class="destacado">Soy muy curiosa e inquieta. Me permito siempre explorar cosas nuevas</p>
    </div>
    ...
    <div class="col-lg-6">
      <p class="text-body mb-4">En 2018 fui co-presidente del Grupo Anticorrupción del G20 y por cuatro años fui jefa de la Oficina Anticorrupción de Argentina.</p>

      <p class="text-body mb-4">Tengo la satisfacción de haber logrado que la Argentina obtenga su mejor calificación en el Índice de Transparencia Internacional. </p>
    </div>
    <div class="col-lg-3">
      <span></span>
    </div>
    ...
    <div class="col-lg-3">
      <p class="destacado">Me gusta pensar fuera de la caja, transformarme y transformar</p>
    </div> 

    <div class="col-lg-6">

      <p class="text-body mb-4">Creo en la capacitación continua, por eso busco siempre oportunidades. Así,  obtuve las becas Chevening, Eisenhower, Draper Hills y Reagan-Fascell. Me reconocieron con el premio de la ONG Vital Voices Global Partnership y fui seleccionada Young Global Leader por el Foro Económico Mundial. En 2021 fui seleccionada Global Fellow por la Universidad de Yale entre 2000 postulantes, donde profundizaré mis conocimientos sobre inteligencia artificial y gobierno digital. </p>
    </div>
    ...
    <div class="col-lg-6">
      <p class="text-body mb-4">Pongo mi experiencia y mis conocimiento al servicio de implementar las mejores prácticas de buen gobierno en el sector público y privado. Me comprometo con los proyectos de las personas o instituciones a las que acompaño. Y me encanta inspirar a líderes en todos los ámbitos. </p>
      ...
      <div class="container">
         ...
         <div class="row mb-5 text-center">
          <div class="col-lg-12 text-center">
            ...
            <p class="text-body mb-4">Dejame tus datos para suscribirte a mi newsletter y recibir novedades.</p>
          </div>

          <div class="col-lg-12 text-center input-form-bio">
